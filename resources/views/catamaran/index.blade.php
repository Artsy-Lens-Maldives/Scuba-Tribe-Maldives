						...
						<div class="col-md-6">
							<div class="recom-item border">
								...
								<div class="recom-item-body">
									<a href="{{ url('catamaran/') }}/{{ $catamaran->slug }}">
										<h6 class="blog-title">{{ $catamaran->name }}</h6>
									</a>
									<p class="mb-30"></p>
									<a href="{{ url('catamaran/') }}/{{ $catamaran->slug }}" class="recom-button">Read more</a><a href="{{ url('catamaran/') }}/{{ $catamaran->slug }}" class="cws-button small alt">Send Inquiry</a>
