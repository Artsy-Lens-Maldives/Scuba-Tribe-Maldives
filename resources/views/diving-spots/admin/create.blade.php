    ...
    <div class="content-body" style="margin-top: 100px">
      <section class="page-section pt-0 pb-50">
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-12">
              <h4 class="trans-uppercase mb-10">Add a new Dive Spot in Local Island</h4>
              <div class="cws_divider mb-30"></div>
            </div>
          </div>
          <form class="form clearfix" action="{{ url()->current() }}/post" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="review-content pattern relative mb-15" style="">
              ...
              <div class="row mt-15">
                <div class="col-md-12">
                  <input type="submit" value="Add Dive Spot" class="cws-button alt float-right">
                </div>
              </div>
            </div>
          </form>
